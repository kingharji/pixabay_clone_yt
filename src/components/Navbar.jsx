...
const Navbar = () => {
    ...
    <>
        <div className='container text-center my-3'>
            ...
            <button onClick={()=>fetchImageByCategory("business")} type="button" className="btn btn-outline-warning mx-3">Business</button>
            <button onClick={()=>fetchImageByCategory("sports")} type="button" className="btn btn-outline-info mx-3">Sports</button>
            <button onClick={()=>fetchImageByCategory("transportation")} type="button" className="btn btn-outline-light mx-3">Transportation</button>
            <button onClick={()=>fetchImageByCategory("animals")} type="button" className="btn btn-outline-primary mx-3">Animals</button>
        </div>
